...
function [SurfTensMills0, SurfTensMills1, SurfTensMills1b] = SurfTens_Method1(T,XSiO2,XTiO2,XAl2O3,XCr2O3,XFeO,XMgO,XMnO,XCaO,XNa2O,XK2O,XLi2O,XCaF2,XZrO2,XB2O3,XCrO,XNiO,XFe2O3,XBaO,XSrO)
    ...
    % Method 0 from paper
    SurfTensMills0 = sum(feed_mol_frac.*gam);
    ...
    X_gam_method1 = X_gam;
    SurfTensMills1 = sum(X_gam_method1)-0.15*(T-1773); % T in K
    SurfTensMills1b = sum(X_gam_method1)-sum(feed_mol_frac.*dGam_dT)*(T-1773);
end